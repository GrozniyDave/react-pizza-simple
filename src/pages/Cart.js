...
const Cart = () => {
  ...
  const onClickOrder = () => {
    ...
    alert('Payment succesful, wait for your pizza!');
  };
    ...
    <div className="container container--cart">
      {totalCount ? (
        <div className="cart">
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              <span>
                Pizzas amount: <b>{totalCount}</b>
              </span>
              <span>
                Total sumary: <b>{(totalPrice * 0.011).toFixed(2)} €</b>
              </span>
            </div>
        ...
        <div className="cart cart--empty">
          <h2>Cart is empty 😕</h2>
          <p>
            Perhaps, you haven't ordered a pizza yet.
            <br />
            Please go to main page to order pizza.
          </p>
